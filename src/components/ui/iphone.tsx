      ...
      >
        <g mask={hasMedia ? "url(#screenPunch)" : undefined}>
          <path
            ...
            className="fill-[#2a2a2a] dark:fill-[#2a2a2a]"
          />
          <path
        ...
        <path
          ...
          className="fill-[#2a2a2a] stroke-[#2a2a2a] stroke-[0.5] dark:fill-[#2a2a2a] dark:stroke-[#2a2a2a]"
          mask={hasMedia ? "url(#screenPunch)" : undefined}
        />

        <path
          d="M154 48.5C154 38.2827 162.283 30 172.5 30H259.5C269.717 30 278 38.2827 278 48.5C278 58.7173 269.717 67 259.5 67H172.5C162.283 67 154 58.7173 154 48.5Z"
          className="fill-[#3a3a3a] dark:fill-[#3a3a3a]"
        />
        <path
